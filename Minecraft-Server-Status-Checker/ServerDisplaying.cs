...
{
    public class ServerDisplaying : Server, INotifyPropertyChanged
    {
        ...
        public ServerDisplaying(string ServerName, string ServerAddress, int port, ServerVersion version) : base(ServerName, ServerAddress, port, version)
        {
